	...
	?>"><?php
		...
		switch ($agency_slug) {
			...
			case 'tvmdl':
				...
				break;
			case 'extension':
				?><div class="wrap"><div class="heading">Established in <div class="date">1915</div></div><div class="image-overlay"><img src="<?php echo ALAF4_DIR_URL;?>images/extension-infographic-main.png" alt="81,292 volunteers supporting extension programs; $158 million FY2017 operating budget including county funds;"><img class="overlay" src="<?php echo ALAF4_DIR_URL;?>images/extension-infographic-overlay.png" alt="250 counties with an extension office"></div><iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d13735.538187426182!2d-96.35795243022461!3d30.60901954999998!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1548179036837" frameborder="0" allowfullscreen></iframe></div><?php
				break;
			case 'research':
				?><div class="wrap"><div class="heading">Established in <div class="date">1887</div></div><div class="image-overlay"><img src="<?php echo ALAF4_DIR_URL;?>images/research-infographic-main.png" alt="#1 FY17 Agriculture Research Expenditures - NSF Higher Education Research and Development Survey FY17"><hr /><br class="show-for-medium"><img class="overlay" src="<?php echo ALAF4_DIR_URL;?>images/research-infographic-overlay.png" alt="13 locations Centers | Divisions"></div><iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d13735.538187426182!2d-96.35795243022461!3d30.60901954999998!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1548179036837" frameborder="0" allowfullscreen></iframe></div><?php
				break;
			case 'forest':
				?><div class="wrap"><div class="heading">Established in <div class="date">1915</div></div><div class="image-overlay"><img src="<?php echo ALAF4_DIR_URL;?>images/forest-infographic-main.png" alt="$265 million in assistance to Volunteer Firefighters; $81.9 million FY 2017 operating budget"><img class="overlay" src="<?php echo ALAF4_DIR_URL;?>images/forest-infographic-overlay.png" alt="65 locations; 25 work stations; 40 offices"></div><iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d13735.538187426182!2d-96.35795243022461!3d30.60901954999998!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1548179036837" frameborder="0" allowfullscreen></iframe></div><?php
				break;
			default:
				break;
		}
