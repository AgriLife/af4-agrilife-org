...
function af4_agency_fields() {
	...
	switch ( $agency_slug ) {
		...
		case 'tvmdl':
			...
			break;
		case 'extension':
			$infographic_output = '<div class="wrap"><div class="heading">Established in <div class="date">1915</div></div><div class="image-overlay"><img src="%simages/extension-infographic-main.png" alt="81,292 volunteers supporting extension programs; $158 million FY2017 operating budget including county funds;"><img class="overlay" src="%simages/extension-infographic-overlay.png" alt="250 counties with an extension office"></div><iframe src="//agrilife.tamu.edu/locations/type/1" frameborder="0" allowfullscreen></iframe></div>';
			break;
		case 'research':
			$infographic_output = '<div class="wrap"><div class="heading">Established in <div class="date">1887</div></div><div class="image-overlay"><img src="%simages/research-infographic-main.png" alt="#1 FY17 Agriculture Research Expenditures - NSF Higher Education Research and Development Survey FY17"><hr /><br class="show-for-medium"><img class="overlay" src="%simages/research-infographic-overlay.png" alt="13 locations Centers | Divisions"></div><iframe src="//agrilife.tamu.edu/locations/type/2" frameborder="0" allowfullscreen></iframe></div>';
			break;
		case 'forest':
			$infographic_output = '<div class="wrap"><div class="heading">Established in <div class="date">1915</div></div><div class="image-overlay"><img src="%simages/forest-infographic-main.png" alt="$265 million in assistance to Volunteer Firefighters; $81.9 million FY 2017 operating budget"><img class="overlay" src="%simages/forest-infographic-overlay.png" alt="65 locations; 25 work stations; 40 offices"></div><iframe src="//agrilife.tamu.edu/locations/type/4" frameborder="0" allowfullscreen></iframe></div>';
			break;
		default:
			break;
	}

	$infographic_output = sprintf(
