...
add_action('genesis_entry_content', function(){
	...
	<div class="introduction layout-container flow-arrow"><p>Agriculture and the life sciences has been an integral part of Texas A&M since 1876 when it was founded as the Agricultural and Mechanical College of Texas. Naturally, with agriculture as one of the pillars on which Texas A&M University was established, the students we educate and the scientific advancements we discover are providing better nutrition and agriculture.</p><p>From long-established majors such as agronomy and animal science to newer programs such as forensics and spatial sciences, the <a href="https://aglifesciences.tamu.edu/">College of Agriculture and Life Sciences</a> is widely recognized as a leader in <a href="https://aglifesciences.tamu.edu/academics/departments/">dozens of academic disciplines</a>.</p></div>
	<div class="buttons flow-arrow"><a class="button" href="https://aglifesciences.tamu.edu/">aglifesciences.tamu.edu</a></div>
...
979.845.3712</p></div></div><div class="photo-column"><img src="<?php echo ALAF4_DIR_URL; ?>images/research-director.jpg" alt="Patrick J. Stover"></div></div>
		<div class="strategic-plan"><a class="button" href="https://agrilifecdn.tamu.edu/wp-content/uploads/ALS_Strategic-Plan_2015.pdf">Strategic Plan</a></div>
	</div>
	<?php
});
