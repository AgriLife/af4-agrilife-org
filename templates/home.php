		...
		<div id="action-items" class="layout-container">
			<div class="item item-1">
				<div class="text-wrap-full">
					...
					<div class="description hide-for-small-only has-line">
						<ul>
							...
							<li>Texas A&M Forest Service</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="item item-2">
				<div class="wrap" style="background-image: url(<?php echo ALAF4_DIR_URL; ?>images/home-about.jpg);">
					<div class="text-wrap">
						<h2>What is <br>Texas A&M AgriLife?</h2>
					</div>
				</div>
			</div>
			<div class="item item-3 featured">
				<div class="wrap" style="background-image: url(<?php echo ALAF4_DIR_URL; ?>images/home-impacts.jpg);">
					<img src="<?php echo ALAF4_DIR_URL; ?>/images/home-impacts.jpg" alt="">
					<div class="text-wrap">
						<h2>Impacts</h2>
						<div class="description hide-for-small-only has-line">Residents, AgriLife Extension, others work to 'Harvey-proof' Houston-area community</div>
					</div>
				</div>
			</div>
			<div class="item item-4">
				<div class="wrap" style="background-image: url(<?php echo ALAF4_DIR_URL; ?>images/home-today.jpg);">
					<div class="text-wrap">
						<h2>AgriLife Today</h2>
						<div class="description hide-for-small-only has-line">Texas A&M AgriLife to lead consortium in establishing Center</div>
					</div>
				</div>
			</div>
			<div class="item item-5"><div class="text-wrap-full"><h2>Vice Chancellor's <span class="big">Newsletter</span></h2><!-- Begin Mailchimp Signup Form -->
