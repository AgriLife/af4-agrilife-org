...
add_action('genesis_entry_content', function(){
	?><div id="overview">
		...
		<div id="action-items" class="layout-container">
			<div class="item item-1"><div class="center-y"><h2>Exceptional Items</h2>
			...
			<div class="item item-4"><img class="hide-for-small-only" src="<?php echo ALAF4_DIR_URL; ?>/images/home-today.jpg" alt=""><h2>AgriLife Today</h2>
				<div class="description has-line hide-for-small-only">Texas A&M AgriLife to lead consortium in establishing Center
			</div></div>
			<div class="item item-5">
				<div class="center-y"><h2>Vice Chancellor's <span class="big">Newsletter</span></h2><!-- Begin Mailchimp Signup Form -->
