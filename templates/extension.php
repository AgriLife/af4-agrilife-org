...
add_action('genesis_entry_content', function(){
	...
	<div class="flowchart">
		<div class="layout-container">
			...
			<div class="flowchart-row bottom"><div class="ext item"><span class="hide-for-small-only img-wrap"><img src="<?php echo ALAF4_DIR_URL; ?>images/extension-cow-icon.png" alt="Cow"></span><p><span>Livestock and Crop protection</span></p></div><div class="res item"><span class="hide-for-small-only img-wrap"><img src="<?php echo ALAF4_DIR_URL; ?>images/extension-water-icon.png" alt="Water"></span><p><span>Drought mitigation and water conservation</span></p></div><div class="college item"><span class="hide-for-small-only img-wrap"><img src="<?php echo ALAF4_DIR_URL; ?>images/extension-apple-icon.png" alt="Apple"></span><p><span>Increasing food security practices</span></p></div><div class="tvmdl item"><span class="hide-for-small-only img-wrap"><img src="<?php echo ALAF4_DIR_URL; ?>images/extension-heart-icon.png" alt="Heart"></span><p><span>Health and wellness education</span></p></div><div class="tfs item"><span class="hide-for-small-only img-wrap"><img src="<?php echo ALAF4_DIR_URL; ?>images/extension-child-icon.png" alt="Child"></span><p><span>Youth Development</span></p></div></div>
		</div>
	</div>
